<template>
  <section class="relative w-full" data-aos="zoom-in-up">
    ...
    <!-- Content -->
    <div
      class="w-full px-5 sm:px-8 md:px-12 lg:px-10 max-w-screen-lg lg:max-w-screen-xl mx-auto relative"
    >
      <div
        class="grid lg:grid-cols-2 gap-6 xl:gap-[2em] relative pt-24 lg:max-w-none md:max-w-xl mx-auto"
      >
        <!-- Text Section -->
        <div class="lg:py-6 flex flex-col">
          <div class="text-left">
          ...
          <!-- Buttons -->
          <div
            class="flex items-center gap-3 pt-9 justify-start lg:justify-start flex-col sm:flex-row"
          >
            <!-- Hire Me Button -->
            <button
              @click="scrollToSection"
              class="px-6 md:px-7 py-3 rounded-full w-full sm:w-auto flex justify-center items-center bg-primary text-white hover:scale-105 transition-transform ease-in-out"
            >
              Hire Me
            </button>
            ...
            <button
              class="border border-primary px-6 md:px-7 py-3 rounded-full w-full sm:w-auto flex justify-center items-center hover:scale-105 transition-transform ease-in-out"
            >
              <div class="flex items-center justify-center">
                ...
                <a
                  href="./Bancale Resume.pdf"
                  download="Bancale Resume.pdf"
