<template>
  <section class="text-white mt-5" id="contact">
    ...
    <div class="grid md:grid-cols-1 gap-4 relative px-4 xl:px-16 mt-10">
      <div>
        <p class="text-lg text-[#adb7be] leading-relaxed mb-6 text-justify">
          Are you looking for someone to
          <span class="font-bold text-yellow-500">turn your data</span> into meaningful
          <span class="font-bold text-yellow-500">insights</span> and provide
          <span class="font-bold text-yellow-500">effective solutions</span>? Do you need
          <span class="font-bold text-yellow-500">dynamic reports</span> that bring
          <span class="font-bold text-yellow-500">clarity</span> and guide
          <span class="font-bold text-yellow-500">smarter decisions</span>? Perhaps you're
          seeking advanced
          <span class="font-bold text-yellow-500">Excel automation</span> with
          <span class="font-bold text-yellow-500">VBA</span> to streamline your workflow,
          or a skilled
          <span class="font-bold text-yellow-500">back-end developer</span> to power your
          applications? Or maybe you need a
          <span class="font-bold text-yellow-500">SQL database expert</span> to manage and
          organize your data efficiently? I’m here to help you tackle challenges, achieve
          your goals, and bring your
          <span class="font-bold text-yellow-500">ideas to reality</span>. Let’s work
          together to make it happen,
          <span class="text-yellow-500 font-bold">reach out today</span>!
        </p>
        ...
        <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
          ...
          <div class="flex mb-10 items-center">
            ...
            <div class="ml-5 text-white">
              ...
              <p>
                <a
                  href="https://www.linkedin.com/in/jesse-dan-bancale-276971188/"
                  target="_blank"
                  class="text-xl underline decoration-[-1px] underline-offset-6"
                  >Jesse Dan Bancale</a
                >
              </p>
            </div>
