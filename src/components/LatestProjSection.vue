<template>
  <section class="text-white mt-20" id="projects">
    <div class="px-4 xl:pl-16">
      <div class="mb-4 md:flex md:justify-between xl:pr-16">
        ...
        <div class="flex space-x-4 mb-4 mt-5 md:mt-0">
          <button
            ...
            v-for="category in ['All', 'Web Development', 'Mobile App', 'Excel VBA']"
            :key="category"
      ...
      <div v-else>
        <ul
          class="px-4 sm:py-16 xl:pr-16 grid grid-cols-1 gap-6 pt-10 sm:grid-cols-2 md:gap-10 md:pt-14 lg:grid-cols-2"
        >
          <!-- data-aos="fade-right" -->
              ...
              <p class="text-[#ADB7BE]">
                {{
                  project.description.length > 100
                    ? project.description.substring(20, 122) + "..."
                    : project.description.substring(20, 122)
                }}
                <button @click="openModal(project)" class="text-primary">See more</button>
              </p>
    ...
    >
      ...
      >
        ...
        <div class="flex justify-between items-center border-b border-gray-300 pb-2 mb-2">
          ...
          <button
            @click="closeModal"
            class="text-2xl text-gray-600 sm:text-3xl md:text-4xl"
          >
            x
          </button>
        </div>
        ...
        <div class="flex flex-col sm:flex-row h-[60vh]">
          <!-- Image Section -->
          <div
            class="w-full sm:w-[55%] flex items-center justify-center"
            :class="{
          ...
          <!-- Description Section -->
          <div
            class="w-full sm:w-[60%] flex flex-col justify-between mt-3 sm:mt-4 sm:ml-6 text-black"
          >
            ...
            <!-- Footer - Technologies -->
            <div
              class="flex flex-wrap mt-2 pt-3 border-t items-center justify-start gap-2 sm:gap-1 sm:mb-2"
            >
              <div
                v-for="technology in modalProject.technologies"
                :key="technology"
                class="text-center text-xs sm:text-sm rounded-3xl bg-white text-black px-2 py-1"
                style="
                  box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);
                  border: 1px solid #111827;
                "
    ...
    <ImageZoomViewer
      v-if="zoomVisible && modalProject && modalProject.images"
...
const openZoom = (index) => {
  if (!modalProject.value || !modalProject.value.images) return;
...
const Projects = ref([
  ...
  },
  {
    ...
    images: [
      ...
      "./image/DataEntry2.jpeg",
      "./image/DataEntry3.jpeg",
    ],
